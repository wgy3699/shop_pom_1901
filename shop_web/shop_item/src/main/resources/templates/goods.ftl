        ...
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')">
                    <IMG height="350" src="http://47.112.140.174/${images[0]}" jqimg="http://47.112.140.174/${images[0]}" width="350">
                </div>
                <div id="spec-n5">
                    ...
                    <div id="spec-list">
                        <ul class="list-h">
                            <#list images as img>
                                <li><img src="http://47.112.140.174/${img}" style="width: 50px; height: 50px"> </li>
                            </#list>
                        </ul>
                    </div>
